...
def load_torchvision_data_repeat(dataname, valid_size=0.1, splits=None, shuffle=True,
                    ...
                    data=None, datadir=None, download=True, filt=False, print_stats = False, shuffle_per=0, repeat_per=0):
...
#  ╚═════╝░╚═╝░░╚═╝░╚═════╝░╚═╝░░░░░╚═╝░░░░░╚══════╝╚══════╝
    ...
    if repeat_per != 0:
        total_repeats = int(repeat_per * len(fold_idxs['train']))
        repeat_inds = np.random.choice(sorted(fold_idxs['train']), size=total_repeats, replace=False)
        
        # get the first index
        get_repeat_ind = repeat_inds[0]
        ## ?????
        ## ?????
        ## ?????
        ## ?????
...
#  ╚═════╝░╚═╝░░╚═╝░╚═════╝░╚═╝░░░░░╚═╝░░░░░╚══════╝╚══════╝
    ...
    print("SAMPLER: ", sampler_class, "\n")
    print("FOLD SAMPLER: ", fold_samplers, "\n")
    print("TRAIN: ", train, "\n")
    print("IDXS: ", fold_idxs['train'], "\n")
...
#             import pdb;pdb.set_trace()
            ...
            new_ds_imgs = []
            new_ds_labs = []
            print('len classes: ', len(train.classes))
            class_len = len(train.classes)
            print('len train: ', len(fold_samplers['train']))
